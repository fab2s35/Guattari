...
import './Dormitorios.css'; // Asegúrate de tener este archivo CSS para los estilos 
  ...
  return (
    <div className="productos-container">
      <div className="breadcrumb">
        <span>Estancias </span> / <span> Dormitorios </span> / <span> <b>Camas</b></span>
      </div>

      <h1 className="productos-titulo">Camas</h1>
